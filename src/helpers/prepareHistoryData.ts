...
export default function prepareHistoryData(mediaId:number, mediaType:MediaTypeApi, mediaDetailsData:ImediaDetailsData | null,episodesArray?:IepisodesArray[] | null,season?:string | null,episode?:string | null){
    ...
    const dataToSave: IhistoryMedia = {
        ...
        vote_average:
        mediaType === "tv" && episodeExists ? episodeVote : mediaDetailsData?.vote,
