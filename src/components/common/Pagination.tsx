  ...
  return (
    <nav className={`flex items-center justify-center w-full px-4 ${customClasses || ""}`}>
      <ul className="flex text-[67%] md:text-[70%] self-center bg-zinc-800 rounded-full">
            ...
            <li key={index}>
              <button
                className={`flex items-center justify-center max-md:px-2.5 px-4 h-8 leading-tight  border border-zinc-500 ${
                  pageNumber === pageActive ? "bg-[goldenrod]  hover:bg-[goldenrod] text-white" : " hover:bg-zinc-500 "
        ...
        <li>
          <button
            className={`flex items-center justify-center max-md:px-2 px-4 h-8 ms-0  leading-tight text-gray-200  border  border-zinc-500 rounded-e-full hover:bg-zinc-500 hover:text-white ${
