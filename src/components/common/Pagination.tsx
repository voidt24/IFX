...
function Pagination({
  ...
  return (
    <nav className={`flex items-center justify-center w-full px-4 ${customClasses || ""} `}>
      <ul className="flex text-[75%] md:text-[70%] self-center  bg-[#0e1017ca] rounded-full">
        <li>
          <button
            className={`flex items-center justify-center max-md:px-4 px-6 h-8 ms-0  leading-tight text-gray-200  border  border-zinc-500 rounded-s-full hover:bg-gray-600 hover:text-white transition-all duration-200 ${
        ...
        {Array.from({ length: lengthOfPag }).map((_, index) => {
          ...
          return (
            <li key={index}>
              <button
                className={`flex items-center justify-center max-md:px-3.5 px-4 h-8 leading-tight border border-zinc-500 transition-all duration-200 ${
                  pageNumber === pageActive ? "bg-brand-primary text-white" : " hover:bg-gray-600 "
        ...
        <li>
          <button
            className={`flex items-center justify-center max-md:px-4 px-6 h-8 ms-0 leading-tight text-gray-200 border border-zinc-500 rounded-e-full hover:bg-gray-600 hover:text-white transition-all duration-200 ${
