  ...
  return modalActive ? (
    <>
      <div className={`flex fixed z-[99999] h-screen w-full top-0 left-0 max-sm:p-6 flex-col justify-center items-center `}>
        ...
        <div className="user-options bg-black relative flex flex-col gap-3 items-center justify-center text-white z-30 border border-white/20 px-6 py-8 w-full  sm:w-3/4 lg:w-3/6 xl:w-1/4">
          <button
            onClick={() => {
              setModalActive(false);
            }}
